...
local function setup_base_highlights(hl, c)
  ...
  hl(0, 'BufferLineError', { fg = c.crimson, bg = c.eerieBlack })
  hl(0, 'BufferLineErrorVisible', { fg = c.crimson, bg = c.eerieBlack })
  hl(0, 'BufferLineErrorSelected', { fg = c.crimson, bg = c.eerieBlack, bold = true })
  hl(0, 'BufferLineWarning', { fg = c.goldenrod, bg = c.eerieBlack })
  hl(0, 'BufferLineWarningVisible', { fg = c.goldenrod, bg = c.eerieBlack })
  hl(0, 'BufferLineWarningSelected', { fg = c.goldenrod, bg = c.eerieBlack, bold = true })
  hl(0, 'BufferLineInfo', { fg = c.crystalBlue, bg = c.eerieBlack })
  hl(0, 'BufferLineInfoVisible', { fg = c.crystalBlue, bg = c.eerieBlack })
  hl(0, 'BufferLineInfoSelected', { fg = c.crystalBlue, bg = c.eerieBlack, bold = true })
  hl(0, 'BufferLineHint', { fg = c.aquamarine, bg = c.eerieBlack })
  hl(0, 'BufferLineHintVisible', { fg = c.aquamarine, bg = c.eerieBlack })
  hl(0, 'BufferLineHintSelected', { fg = c.aquamarine, bg = c.eerieBlack, bold = true })
