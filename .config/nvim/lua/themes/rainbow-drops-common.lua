...
local function setup_lsp_highlights(hl, c)
  -- LSP ハイライト
  hl(0, '@lsp.mod.documentation', { fg = c.tan, bold = true })
  hl(0, '@lsp.mod.annotation', { fg = c.silver })
  ...
  hl(0, '@lsp.type.annotation', { link = '@lsp.mod.annotation' })
  ...
  hl(0, '@lsp.typemod.property.annotation', { link = '@lsp.mod.annotation' })
  hl(0, '@lsp.typemod.comment.documentation', { link = '@comment' })
  ...
  hl(0, '@lsp.typemod.interface.defaultLibrary', { link = '@lsp.type.interface' })
